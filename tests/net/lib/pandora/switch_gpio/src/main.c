...
struct pandora_switch_gpio_tests_fixture {
...
{
	static struct pandora_switch_gpio_tests_fixture fixture = {
...
ZTEST_SUITE(pandora_switch_gpio_tests, NULL, switch_gpio_setup, NULL, NULL, NULL);

ZTEST_F(pandora_switch_gpio_tests, test_pandora_switch_switch_gpio_set_state_on)
{
	int ret;
...
ZTEST_F(pandora_switch_gpio_tests, test_pandora_switch_gpio_set_state_off)
{
	int ret;
...
ZTEST_F(pandora_switch_gpio_tests, test_pandora_switch_gpio_get_state)
{
	int state;
	int ret;
